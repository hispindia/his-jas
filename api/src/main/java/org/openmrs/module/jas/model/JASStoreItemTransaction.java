...
public class JASStoreItemTransaction implements Serializable {
	...
	private Set<JASStoreItemIndent> indents;
	...
	public Set<JASStoreItemIndent> getIndents() {
		return indents;
	}
	
	public void setIndents(Set<JASStoreItemIndent> indents) {
