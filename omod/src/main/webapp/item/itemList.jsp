...
<openmrs:require privilege="View Item" otherwise="/login.htm" redirect="/module/jas/itemList.form" />

<spring:message var="pageTitle" code="jas.item.manage" scope="page"/>

<%@ include file="/WEB-INF/template/header.jsp" %>

<%@ include file="nav.jsp" %>
<h2><spring:message code="jas.item.manage"/></h2>	

<br />
<c:forEach items="${errors.allErrors}" var="error">
	<span class="error"><spring:message code="${error.defaultMessage}" text="${error.defaultMessage}"/></span><
</c:forEach>
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code='jas.item.add'/>" onclick="ACT.go('item.form');"/>
...
<table cellpadding="5" cellspacing="0">
	<tr>
	    <td><spring:message code="jas.item.subCategory"/></td>
		<td>
...
<tr>
	...
	<th><spring:message code="jas.item.unit"/></th>
	...
	<th><spring:message code="jas.item.attribute"/></th>
	<th><spring:message code="jas.item.reorderQty"/></th>
	<th><spring:message code="jas.item.createdDate"/></th>
	<th><spring:message code="jas.item.createdBy"/></th>
	<th></th>
</tr>
