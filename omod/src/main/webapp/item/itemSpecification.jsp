...
<openmrs:require privilege="Add/Edit itemSpecification" otherwise="/login.htm" redirect="/module/jas/itemSpecification.form" />
...
<table>
	<tr>
		...
		<td><spring:message code="jas.itemSpecification.name"/><em>*</em></td>
		<td>
	...
	<tr>
		<td valign="top"><spring:message code="jas.itemSpecification.description"/></td>
		<td>
