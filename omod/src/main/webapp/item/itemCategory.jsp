...
<openmrs:require privilege="Add/Edit itemCategory" otherwise="/login.htm" redirect="/module/jas/itemCategory.form" />
...
<table>
	<tr>
		...
		<td><spring:message code="jas.itemCategory.name"/><em>*</em></td>
		<td>
	...
	<tr>
		<td valign="top"><spring:message code="jas.itemCategory.description"/></td>
		<td>
