...
<openmrs:require privilege="Add/Edit Item" otherwise="/login.htm" redirect="/module/jas/item.form" />
...
<table>
	...
	<tr>
		<td><spring:message code="jas.item.unit"/><em>*</em></td>
		<td>
	...
	<tr>
		<td><spring:message code="jas.item.specification"/></td>
	...
	<tr>
		<td><spring:message code="jas.item.attribute"/><em>*</em></td>
		<td>
	...
	<tr  class="depentOnAttribute" <c:if test="${item.attribute != 1 }"> style='display: none;'</c:if> >
		<td><spring:message code="jas.item.reorderQty"/><em>*</em></td>
		<td>
