...
<spring:message var="pageTitle" code="jas.indentItem.manager" scope="page"/>
...
<table class="box">
	<tr>
		<td><spring:message code="jas.indentItem.quantity"/><em>*</em></td>
		<td>
...
<br/>
<input type="submit" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code="jas.indentItem.addToSlip"/>">
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code="jas.back"/>" onclick="ACT.go('subStoreIndentItemList.form');">
</form>
</div>
</div>
<!-- indent list -->
...
<br/>
	<c:if  test="${not empty listIndent}">
		...
		<tr>
			<td>
				<!--<input type="button" value="<spring:message code="jas.indentItem.finish"/>" onclick="INDENT.processSlipItem('0');" />
				-->
				<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code="jas.indentItem.saveAndSend"/>" onclick="INDENT.processSlipItem('2');" />
				<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code="jas.print"/>" onClick="INDENT.printDiv();" />
				<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code="jas.clear"/>"  onclick="INDENT.processSlipItem('1');"/>
			</td>
		</tr>
		</table>
	</c:if>
