...
<h2><spring:message code="jas.issueItem.manage"/></h2>	
<br />
<c:forEach items="${errors.allErrors}" var="error">
	<span class="error"><spring:message code="${error.defaultMessage}" text="${error.defaultMessage}"/></span><
</c:forEach>
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code='jas.issueItem.add'/>" onclick="ACT.go('subStoreIssueItemForm.form');"/>
<br /><br />

<form method="get"  id="form">
<table >
	<tr>
		<td><spring:message code="jas.issueItem.name"/></td>
		<td>
...
<br />
<span class="boxHeader"><spring:message code="jas.issueItem.list"/></span>
<div class="box">
<table width="100%" cellpadding="5" cellspacing="0">
	<tr>
	<th>#</th>
	<th><spring:message code="jas.issueItem.name"/></th>
	<th><spring:message code="jas.issueItem.createdOn"/></th>
	</tr>
	<c:choose>
