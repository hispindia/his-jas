...
<spring:message var="pageTitle" code="jas.indentItem.manage" scope="page"/>
<%@ include file="/WEB-INF/template/header.jsp" %>
<%@ include file="../includes/js_css.jsp" %>
<%@ include file="nav.jsp" %>
<h2><spring:message code="jas.indentItem.manage"/></h2>	
...
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code='jas.indentItem.add'/>" onclick="ACT.go('subStoreIndentItem.form');"/>

<br /><br />
<form method="get"  id="formSubStoreIndentList">
<table >
	<tr>
		<td><spring:message code="jas.indentItem.status"/></td>
		<td>
...
<span class="boxHeader"><spring:message code="jas.indentItem.list"/></span>
<div class="box">
<c:choose>
...
<tr>
	<th >#</th>
	<th align="center" ><spring:message code="jas.indentItem.name"/></th>
	<th align="center" ><spring:message code="jas.indentItem.createdOn"/></th>
	<th align="center" ><spring:message code="jas.indentItem.status"/></th>
	<th></th>
...
<c:forEach items="${listIndent}" var="indent" varStatus="varStatus">
	<tr class='${varStatus.index % 2 == 0 ? "oddRow" : "evenRow" } '>
		...
		<c:if test="${indent.subStoreStatus == 1 }">
			<a href="#" onclick="INDENT.sendToMainStoreItem('${ indent.id}');"><spring:message code="jas.indentItem.send"/></a>
		</c:if>
		<c:if test="${indent.subStoreStatus == 3 }">
			<a href="#" onclick="ACT.go('subStoreItemProcessIndent.form?indentId=${ indent.id}');"><spring:message code="jas.indentItem.process"/></a>
		</c:if>
