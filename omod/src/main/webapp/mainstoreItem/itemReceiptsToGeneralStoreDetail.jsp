...
<span class="boxHeader"><spring:message code="jas.receiptItem.receiptItemList"/></span>
<div class="box">
...
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code="jas.receiptItem.print"/>" onClick="INDENT.printDiv();" />
<!-- PRINT DIV -->
