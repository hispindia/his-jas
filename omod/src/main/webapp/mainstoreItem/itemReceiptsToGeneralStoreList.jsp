...
<h2><spring:message code="jas.receiptItem.manage"/></h2>	
<br />
<c:forEach items="${errors.allErrors}" var="error">
	<span class="error"><spring:message code="${error.defaultMessage}" text="${error.defaultMessage}"/></span><
</c:forEach>
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code='jas.receiptItem.add'/>" onclick="ACT.go('itemReceiptsToGeneralStore.form');"/>
<br /><br />

<form method="get"  id="form">
<table >
	<tr>
		<td><spring:message code="jas.receiptItem.description"/></td>
		<td>
...
<table width="100%" cellpadding="5" cellspacing="0">
	<tr align="center">
	<th>#</th>
	<th><spring:message code="jas.receiptItem.description"/></th>
	<th><spring:message code="jas.receiptItem.createdOn"/></th>
	<!--<th><spring:message code="jas.receiptItem.number"/></th>
	--></tr>
	<c:choose>
