...
<spring:message var="pageTitle" code="jas.purchase.manage" scope="page"/>
<%@ include file="/WEB-INF/template/header.jsp" %>
<%@ include file="nav.jsp" %>
<h2><spring:message code="jas.purchase.manage"/></h2>	
<br />
<c:forEach items="${errors.allErrors}" var="error">
	<span class="error"><spring:message code="${error.defaultMessage}" text="${error.defaultMessage}"/></span><
</c:forEach>
<input type="button" class="ui-button ui-widget ui-state-default ui-corner-all" value="<spring:message code='jas.purchaseItem.add'/>" onclick="ACT.go('itemPurchaseOrderForGeneralStore.form');"/>
<br /><br />

<form method="get"  id="form">
<table >
	<tr>
		<td><spring:message code="jas.purchaseItem.name"/></td>
		<td>
...
<br />
<span class="boxHeader"><spring:message code="jas.purchaseItem.list"/></span>
<div class="box">
<table width="100%" cellpadding="5" cellspacing="0">
	<tr>
	<th>#</th>
	<th><spring:message code="jas.purchaseItem.name"/></th>
	<th><spring:message code="jas.purchaseItem.createdOn"/></th>
	</tr>
	<c:choose>
