...
<openmrs:require privilege="View mainstore" otherwise="/login.htm" redirect="/module/jas/main.form" />
...
<table >
	<tr>
		<td valign="top"><spring:message code="jas.store.store"/></td>
		<td>
...
<tr align="center">
	<th >#</th>
	<th align="center" ><spring:message code="jas.indentItem.fromStore"/></th>
...
<c:forEach items="${listIndent}" var="indent" varStatus="varStatus">
	<tr align="center" class='${varStatus.index % 2 == 0 ? "oddRow" : "evenRow" } '>
		...
		<c:if test="${indent.mainStoreStatus == 1 }">
			<a href="#" onclick="ACT.go('mainStoreItemProcessIndent.form?indentId=${ indent.id}');"><spring:message code="jas.indentItem.process"/></a>
		</c:if>
		</td>
	</tr>
</c:forEach>
