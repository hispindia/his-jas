...
<openmrs:require privilege="manage JAS" otherwise="/login.htm" redirect="/module/jas/drugCategory.form" />
...
<table>
	<tr>
		...
		<td><spring:message code="jas.drugCategory.name"/><em>*</em></td>
		<td>
	...
	<tr>
		<td valign="top"><spring:message code="jas.drugCategory.description"/></td>
		<td>
