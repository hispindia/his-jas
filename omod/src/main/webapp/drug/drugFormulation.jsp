...
<openmrs:require privilege="manage JAS" otherwise="/login.htm" redirect="/module/jas/drugFormulation.form" />
...
<table>
	<tr>
		...
		<td><spring:message code="jas.drugFormulation.name"/><em>*</em></td>
		<td>
	...
	<tr>
		<td valign="top"><spring:message code="jas.drugFormulation.dozage"/><em>*</em></td>
		<td>
	...
	<tr>
		<td valign="top"><spring:message code="jas.drugFormulation.description"/></td>
		<td>
