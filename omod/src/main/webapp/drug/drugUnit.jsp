...
<openmrs:require privilege="manage JAS" otherwise="/login.htm" redirect="/module/jas/drugUnit.form" />
...
<table>
	<tr>
		...
		<td><spring:message code="jas.drugUnit.name"/><em>*</em></td>
		<td>
	...
	<tr>
		<td valign="top"><spring:message code="jas.drugUnit.description"/></td>
		<td>
